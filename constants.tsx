    ...
    floors: [
      ...
      },
      {
        ...
        monsters: [
          ...
          { id: 'nv-10-3', name: '순례길 보라 트리피드', type: 'static', appearanceRange: '91~93층', detectionType: '소리 감지', aoeShape: '원형장판, 부채꼴 장판', immuneCC: [CrowdControl.SLOW], skills: ['기어드는 덩굴'], avoidance: '랜덤 대상자를 향한 원형 장판, 기어드는 덩굴: 랜덤 대상자를 향해 부채꼴 장판', threatLevel: 2 },
